...
class 삼성Tv extends 표준Tv {
    void 이름세팅() {
        brand = "삼성Tv"; // = 변수 선언(만들기). 표준Tv에게 물려받은 brand 변수와는 다르다. 삼성Tv에게만 있는 변수이다.
    }
    // 연산은 함수에서만 가능.
...
class 샤오미Tv extends 표준Tv {
    void 이름세팅() {
        brand = "샤오미Tv"; // = 변수 선언(만들기). 표준Tv에게 물려받은 brand 변수와는 다르다. 삼성Tv에게만 있는 변수이다.
    }
    void vr켜기() {
...
class LGTv extends 표준Tv {
    void 이름세팅() {
        brand = "LGTv"; // = 변수 선언(만들기). 표준Tv에게 물려받은 brand 변수와는 다르다. 삼성Tv에게만 있는 변수이다.
    }
    void 게임모드전환() {
