...
public class TestExam1 {
    public static void main(String[] args) {
        ...
        if (num % 2 == 0) {
            ...
            System.out.println(num + "는(은) even입니다.");
        }
        else{
            System.out.println(num + "는(은) add입니다.");
        ...
        */
        ...
        if (car >= tunnel1){
            System.out.println("1번째 터널에서 CRASH!!!");
        }
        else if (car >= tunnel2) {
            System.out.println("2번째 터널에서 CRASH!!!");
        }
        else if (car >= tunnel3) {
            System.out.println("3번째 터널에서 CRASH!!!");
        }
        else {
            System.out.println("모든 터널을 PASS했습니다.");
